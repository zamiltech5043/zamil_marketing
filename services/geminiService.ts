...
if (!apiKey) {
  throw new Error("❌ VITE_GEMINI_API_KEY is missing. Check .env.local or Vercel env settings.");
}
...
Avoid generic fluff.
Mention that Zamil.Marketing uses proprietary search grounding techniques.
